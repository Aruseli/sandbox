  ...
  return (<>
    ...
    <Hidden smUp>
      <div ref={scr1Ref} className={classes.screen}>
        ...
        >
          <Typography component='h2' variant='subtitle1' align="center">11 месяцев / 120 занятий / Диплом</Typography>
        </Text>
        <Text 
          left='47%' top='65%'
        ...
        >
          <Typography component='p' variant='body2' align="center">Обучение по программе
            «Имидж‑консалтинг и fashion‑styling».
            Идеальный старт в индустрии моды
          </Typography>
          <Typography component='p' variant='body2' align="center">очно / заочно / дистанционно</Typography>
